package com.spring.rest.streamsschedule.repository;

import com.spring.rest.streamsschedule.exception.LiveStreamNotFoundException;
    ...
    public LiveStreamRepository() {
        streams.add(new LiveStream(
                ...
                """
                 ...
                 """,
                "https://www.youtube.com/c/RahulSam",
